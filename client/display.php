...
<body>
    <div id="nn">
        ...
        <div class="navbar" >                
            ...
            <div id="navbar_options" ><a href="logout.php"  title="Logout"><?php echo $client_name ?></a>
                <div title="Logout">
    ...
    <div class="sort-btns">
        ...
        <div id="sort-btn">
            <input class="w3-radio" type="radio" name="sort-btns" id="by-name" onclick="sort()">
            <label for="by-name">Property Name</label>
        </div>
        <div id="sort-btn">
            <input type="radio" name="sort-btns" id="by-price-low" onclick="sort()">
            <label for="by-price-low">Price - Lowest</label>
        </div>
        <div id="sort-btn">
            <input type="radio" name="sort-btns" id="by-price-high" onclick="sort()">
            <label for="by-price-high">Price - Lowest</label>
        </div>
        <div id="sort-btn">
            <input type="radio" name="sort-btns" id="by-location" onclick="sort()">
    ...
    <div id="property_listings" style="display: block; width: 80%; margin: auto;">
                            ...
                            echo "<div class='w3-container' style='width: 50%; display: inline-block; padding: 1em 16px !important;'>
                                  ...
                                  <div class='w3-card-4' style='width:100%'>
                                    <form action='display_property.php' method='post'>
                                        <input type='hidden' id='pid' name='pid' value='". $property_id ."'>
                                        <img src='".$picture_url."' alt='Alps' style='width:100%''>
                                        <div class='w3-container w3-center' style='text-align: center !important'>
                                          <h3><strong>".$row['property_name']."</strong></h3>
                                          <p>Ksh. ".$row['price']."</p>
                                          <p style='color: gray;'>".$row['location']."</p>
                                        </div>
            ...
            <script>
                ...
                {
                    window.location.href = "display_property.php";
                }
